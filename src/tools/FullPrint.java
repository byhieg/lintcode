...
public class FullPrint {
    ...
    public static void printIntArraysInSys(int[] arrays) {
        System.out.println("数组长度是 " + arrays.length);
        System.out.println(Arrays.toString(arrays));
    }

    public static void printDoubleArraysInSys(double[] arrays) {
        System.out.println("数组长度是 " + arrays.length);
        System.out.println(Arrays.toString(arrays));
    }


    public static void printDoubleArrays(double[] arrays) {
        System.out.println("数组长度是 " + arrays.length);
        for (int i = 0 ; i < arrays.length;i++) {
            System.out.println("第 " + (i + 1) + " 项元素是 " + arrays[i]);
        }
